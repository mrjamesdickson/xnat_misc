-- Test All Foreign Key Indexes
-- Purpose: Run automated A/B tests on all foreign keys without indexes
-- Usage: psql -h localhost -U postgres -d xnat -f test_all_foreign_keys.sql
-- Duration: ~30-60 minutes depending on table sizes
